                    ...
                    <article class="post post-grid">
                        <div class="post-thumb">
                            <a href="{{route('arts.show', $art->slug)}}">
                                <img src="{{$art->getImage()}}" alt="" style="object-fit: cover; max-height: 168px;">
                            </a>

                            <a href="{{route('arts.show', $art->slug)}}" class="post-thumb-overlay text-center">
                        ...
                        <div class="post-content">
                            <header class="entry-header text-center text-uppercase">
                                ...
                                <h1 class="entry-title"><a href="{{route('arts.show', $art->slug)}}">{{$art->title}}</a>
                                </h1>
                            </header>
                            <div class="entry-content">
                                ...
                                <div class="social-share">
                                                <span class="social-share-title pull-left text-capitalize">
                                                    By
                                                    <a href="{{route('profile.show', $art->author->slug)}}">{{$art->author->name}}</a>
                                                    on {{$art->getDate()}}
                                                </span>
                                </div>
                            </div>
...
{{--                                    <div class="post-content">--}}
{{--                                        <header class="entry-header text-center text-uppercase">--}}
{{--                                                <h6><a href="#"> {{$post->subcategory->title}}</a></h6>--}}
