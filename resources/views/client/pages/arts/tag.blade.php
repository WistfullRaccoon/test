    ...
    <div class="col-md-10">
        <div class="cards-content">
            @foreach($arts as $art)
                <article class="art">
                    <div class="art-thumb">
                        <a href="{{route('arts.show', $art->slug)}}"><img src="{{$art->getImage()}}" alt=""></a>
                        <div class="art-thumb-overlay">
                            <div class="title"><a href="{{route('arts.show', $art->slug)}}">{{$art->title}}</a></div>
                            ...
                            <div class="likes"><a href="{{route('arts.like')}}">Three</a></div>
                        </div>
                    </div>
