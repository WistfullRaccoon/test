...
@section('content')
    <div class="d-flex justify-content-center" >
        {!! Form::open([
            'route' => ['profile.teacher.lessons.update', $lesson],
            'files' => true,
            'method' => 'put'
            ])!!}
            ...
            <div class="box-body">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputTitle" placeholder="" name="title" value="{{$lesson->title}}">
                    </div>
                    <div class="form-group">
                        <label for="inputTitle">Ссылка на видео</label>
                        <input type="text" class="form-control" id="inputTitle" placeholder="" name="video" value="{{$lesson->video}}">
                    </div>
                    <div class="form-group">
                        <label for="inputTitle">Домашнее задание</label>
                        <input type="text" class="form-control" id="inputTitle" placeholder="" name="task" value="{{$lesson->task}}">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
