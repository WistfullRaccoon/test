    ...
    <div class="d-flex justify-content-center" >
        ...
        <div class="box" style="margin-top:30px; margin-bottom:70px">
            <div class="box-header with-border">
                ...
                <h3 class="box-title" style="margin-left:10px">Редактировать работу</h3>
            ...
            <div class="box-body">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputTitle" value="{{$art->title}}" placeholder="" name="title">
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" cols="30" rows="5"
                                  class="form-control">{!! $art->description !!}</textarea>
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
